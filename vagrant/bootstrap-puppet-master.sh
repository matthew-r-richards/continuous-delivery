...
sudo /opt/puppetlabs/bin/puppet module install --environment qa puppetlabs-ntp
sudo /opt/puppetlabs/bin/puppet module install --environment qa garethr-docker
